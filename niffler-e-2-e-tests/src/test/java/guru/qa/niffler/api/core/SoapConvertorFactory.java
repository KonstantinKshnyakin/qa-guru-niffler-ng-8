...
public class SoapConvertorFactory extends Converter.Factory {

    public static final MediaType XML = MediaType.get("application/xml; charset=utf-8");

    public static SoapConvertorFactory create(@Nonnull String namespace) {
        return new SoapConvertorFactory(null, namespace);
    }

    public static SoapConvertorFactory create(@Nullable JAXBContext context, @Nonnull String namespace) {
        return new SoapConvertorFactory(context, namespace);
    }

    private final @Nullable JAXBContext context;
    private final @Nonnull String namespace;

    private SoapConvertorFactory(@Nullable JAXBContext context, @Nonnull String namespace) {
